...
function Testimonial() {
    const testimonials = [
        ...
        { name: "Alex Smith", 
            ...
            testimonial: "Fantastic experience! Everything was smooth, quick, and handled with great care. Highly satisfied with the service." 
          },
          { name: "Ben Duckett", 
            location: "Toronto, Canada", 
            image:assets.testimonial_image_1, 
            testimonial: "Great service from start to finish. Very professional and easy to work with. Definitely recommend!" 
          }
